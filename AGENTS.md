...
- If you wish to generate data mechanically, create C++ code or Python scripts within the tmp folder.
- For primality testing in Python, you can use Scipy. For execution speed, prioritize using PyPy.
